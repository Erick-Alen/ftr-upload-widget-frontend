  ...
  return (
    <div className="flex flex-col gap-3 px-3">
      ...
      <Root className="overflow-hidden">
        ...
        >
          <Thumb className="before:-translate-x-1/2 before:-translate-y-1/2 relative flex-1 rounded-[10px] bg-zinc-600 before:absolute before:top-1/2 before:left-1/2 before:size-full before:min-h-11 before:min-w-11" />
        </Scrollbar>
      </Root>
    </div>
  );
